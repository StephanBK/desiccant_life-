  ...
  return (
    <div className="explain">
      <div className="card">
        ...
        <Step title="2. Air through it, and air around each layer" figure={<FigStreams aOut={pr ? fmt.g(pr.mean_loop_out_ach + (pr.hours_outdoor_fed > pr.hours_room_fed ? pr.mean_through_ach : 0)) : (i?.ach_out ?? '—')} aIn={pr ? fmt.g(pr.mean_loop_in_ach + (pr.hours_room_fed >= pr.hours_outdoor_fed ? pr.mean_through_ach : 0)) : (i?.ach_in ?? '—')} />}>
